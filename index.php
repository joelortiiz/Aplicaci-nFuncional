    ...
    <body>
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <header class= "text-center">
                <h1 class="title fs-2">Talavera Collection Store</h1>
                <h2 class="fs-3">Inventory management</h2>
                <div>
            ...
            <div class="d-flex align-items-start text-center justify-content-between">
                <?php 
                ...
                <form action="./pages/newUser.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="direccion" placeholder="Av. América 31" name="direccion">
                    </div>

                    <div class="form-group">
                        <label for="telefono">Telefono</label>
                        <input type="tel" class="form-control" id="telefono" placeholder="+34" name="telefono">
                    </div>
